(function(b, S) {
    typeof exports == "object" && typeof module < "u" ? S(exports) : typeof define == "function" && define.amd ? define(["exports"], S) : (b = typeof globalThis < "u" ? globalThis : b || self, S(b.frostui = {}))
})(this, function(b) {
    "use strict";
    var _e = Object.defineProperty;
    var Ae = (b, S, P) => S in b ? _e(b, S, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: P
    ...
    class I {
        constructor(i, t) {
            ...
            o(this, "_destroyed", !1);
            o(this, "_config", {});
            typeof i == "string" ? this._element = p.findOrById(i) : this._element = i, this._config = t ? ? {}, this._element != null && P.set(this.constructor.type, this._element, this)
        }
        get config() {
            return this._config ? ? {}
        }
        ...
        destroy() {
            this._destroyed = !0, this._element != null && P.remove(this.constructor.type, this._element)
        }
    }
    o(I, "type", "");
    const Lt = {
        ...
        F = class extends I {
            ...
            init() {
                this._element != null && (this._element.classList.add(F.DEFAULT.class.base), this._targetElement = this.getTargetElement()), this.initOptions(), this.initListener()
            }
            initOptions() {
                this._targetElement != null && !this._targetElement.classList.contains(F.DEFAULT.class.hidden) && this._element.classList.add(F.DEFAULT.class.open), this.config.toggle && this.toggle()
            }
            initListener() {
            ...
            get isShown() {
                var t;
                return ((t = this._element) == null ? void 0 : t.classList.contains(F.DEFAULT.class.open)) ? ? !1
            }
            show() {
                this._destroyed || (this.dispatchEvent(F.EVENTS.show), this._targetElement != null && this._element != null && (this._element.classList.add(F.DEFAULT.class.open), this._targetElement.classList.remove(F.DEFAULT.class.hidden), this._targetElement.style.height = "0px", this._targetElement.style.height = `${this._targetElement.scrollHeight}px`, Lt.afterTransition(this._targetElement, () => {
                    this.isShown && (this._targetElement.style.height = "")
                })), this.dispatchEvent(F.EVENTS.shown))
            }
            hide() {
                this._destroyed || (this.dispatchEvent(F.EVENTS.hide), this._targetElement != null && this._element != null && (this._element.classList.remove(F.DEFAULT.class.open), this._targetElement.style.height = `${this._targetElement.scrollHeight}px`, Lt.afterTransition(this._targetElement, () => {
                    this.isShown || (this._targetElement.classList.add(F.DEFAULT.class.hidden), this._targetElement.style.height = "")
                }), setTimeout(() => {
            ...
            getTargetElement() {
                ...
                const t = this.config.target ? ? this._element.getAttribute(F.DEFAULT.attr.target);
                return typeof t == "string" ? p.findOrById(t) : t instanceof HTMLElement ? t : p.nextElementSibling(this._element)
            }
        };
    let O = F;
    o(O, "type", "collapse"), o(O, "SELECTOR", '[data-fc-type="collapse"]'), o(O, "EVENTS", {
        ...
        class: {
            base: "fc-collapse", hidden: "hidden", open: "open"
        },
        attr: {
    ...
    const xt = class extends I {
        ...
        init() {
            if (this._element != null) {
                ...
                if (!n) this.targetCollapses = t.map(s => O.getInstanceOrCreate(s));
                else {
                    const s = this._element.id;
                    this.targetCollapses = t.filter(a => a.getAttribute(xt.DEFAULT.attr.parent) == s).map(a => O.getInstanceOrCreate(a))
                }
                this.initListeners()
            }
        }
    ...
    let X = xt;
    o(X, "type", "accordion"), o(X, "SELECTOR", '[data-fc-type="accordion"]'), o(X, "DEFAULT", {
        attr: {
    ...
    const ae = async (e, i, t) => {
        const {
            ...
            middleware: a = [],
            platform: l
        } = t, r = a.filter(Boolean), d = await (l.isRTL == null ? void 0 : l.isRTL(i));
        ...
        for (let u = 0; u < r.length; u++) {
            ...
            }, U && E <= 50 && (E++, typeof U == "object" && (U.placement && (m = U.placement), U.rects && (h = U.rects === !0 ? await l.getElementRects({
                reference: e,
                floating: i,
                strategy: s
            }) : U.rects), {
    ...
    async function Mt(e, i) {
        ...
        const {
            ...
            altBoundary: m = !1,
            padding: g = 0
        } = i, E = Ht(g), u = r[m ? c === "floating" ? "reference" : "floating" : c], L = yt(await a.getClippingRect({
            ...
            rootBoundary: f,
            strategy: d
        })), v = c === "floating" ? { ...l.floating,
            x: n,
            y: s
        } : l.reference, y = await (a.getOffsetParent == null ? void 0 : a.getOffsetParent(r.floating)), _ = await (a.isElement == null ? void 0 : a.isElement(y)) && await (a.getScale == null ? void 0 : a.getScale(y)) || {
            x: 1,
            y: 1
        }, R = yt(a.convertOffsetParentRelativeRectToViewportRelativeRect ? await a.convertOffsetParentRelativeRectToViewportRelativeRect({
            rect: v,
            offsetParent: y,
            strategy: d
        }) : v);
    ...
    const ce = e => ({
        ...
        async fn(i) {
            ...
            const f = Ht(n),
                ...
                R = c[m] - r.reference[m],
                U = await (d.getOffsetParent == null ? void 0 : d.getOffsetParent(t));
            let J = U ? U[y] : 0;
            J && await (d.isElement == null ? void 0 : d.isElement(U)) || (J = h.floating[y] || r.floating[g]);
            const lt = _ / 2 - R / 2,
                at = f[L],
                Et = J - E[g] - f[v],
                M = J / 2 - E[g] / 2 + lt,
                k = Ut(at, M, Et),
                $ = dt(l) != null && M != k && r.reference[g] / 2 - (M < at ? f[L] : f[v]) - E[g] / 2 < 0;
            return {
    ...
    ["top", "right", "bottom", "left"].reduce((e, i) => e.concat(i, i + "-start", i + "-end"), []);
    const he = {
        left: "right",
        right: "left",
        bottom: "top",
    ...
    function de(e, i, t) {
        ...
        return i.reference[a] > i.floating[a] && (l = wt(l)), {
            main: l,
            cross: wt(l)
        }
    }
            ...
            return e === void 0 && (e = {}), {
                ...
                async fn(i) {
                    ...
                    const {
                        ...
                        flipAlignment: E = !0,
                        ...u
                    } = e, L = et(n), v = et(l) === l, y = await (r.isRTL == null ? void 0 : r.isRTL(d.floating)), _ = c || (v || !E ? [wt(l)] : function(k) {
                        const $ = wt(k);
                        return [Ot(k), $, Ot($)]
                    }(l));
                    c || g === "none" || _.push(... function(k, $, rt, tt) {
                        const K = dt(k);
                        ...
                        return K && (N = N.map(pt => pt + "-" + K), $ && (N = N.concat(N.map(Ot)))), N
                    }(l, E, g, y));
                    const R = [l, ..._],
                        U = await Mt(i, u),
                        J = [];
                    let lt = ((t = s.flip) == null ? void 0 : t.overflows) || [];
                    if (h && J.push(U[L]), f) {
                        const {
                            main: k,
                            cross: $
                    ...
                    if (lt = [...lt, {
                        ...
                        var at, Et;
                        const k = (((at = s.flip) == null ? void 0 : at.index) || 0) + 1,
                            $ = R[k];
                        if ($) return {
                            data: {
                                index: k,
                        ...
                        let rt = (Et = lt.filter(tt => tt.overflows[0] <= 0).sort((tt, K) => tt.overflows[1] - K.overflows[1])[0]) == null ? void 0 : Et.placement;
                        if (!rt) switch (m) {
                            case "bestFit":
                                {
                                    var M;
                                    const tt = (M = lt.map(K => [K.placement, K.overflows.filter(N => N > 0).reduce((N, pt) => N + pt, 0)]).sort((K, N) => K[1] - N[1])[0]) == null ? void 0 : M[0];tt && (rt = tt);
                                    break
                                }
            ...
            return e === void 0 && (e = 0), {
                ...
                async fn(i) {
                    const {
                        x: t,
                        y: n
                    } = i, s = await async function(a, l) {
                        const {
                            placement: r,
                            platform: d,
                            elements: h
                        } = a, f = await (d.isRTL == null ? void 0 : d.isRTL(h.floating)), c = et(r), m = dt(r), g = ft(r) === "x", E = ["left", "top"].includes(c) ? -1 : 1, u = f && g ? -1 : 1, L = typeof l == "function" ? l(a) : l;
                        let {
                            mainAxis: v,
                            crossAxis: y,
                            alignmentAxis: _
                        ...
                        return m && typeof _ == "number" && (y = m === "end" ? -1 * _ : _), g ? {
                            x: y * u,
                            y: v * E
                        } : {
                            x: v * E,
        ...
        return e === void 0 && (e = {}), {
            ...
            async fn(i) {
                const {
                    ...
                    x: t,
                    y: n
                }, f = await Mt(i, d), c = ft(et(s)), m = ge(c);
                let g = h[c],
                    E = h[m];
                if (a) {
    ...
    function Wt() {
        ...
        return e && Array.isArray(e.brands) ? (vt = e.brands.map(i => i.brand + "/" + i.version).join(" "), vt) : navigator.userAgent
    }
    ...
    function jt(e) {
        return typeof ShadowRoot > "u" ? !1 : e instanceof C(e).ShadowRoot || e instanceof ShadowRoot
    }
    ...
    function gt(e, i, t, n) {
        ...
        const h = r ? C(r) : window,
            f = Rt() && t;
        let c = (l.left + (f && ((s = h.visualViewport) == null ? void 0 : s.offsetLeft) || 0)) / d.x,
            m = (l.top + (f && ((a = h.visualViewport) == null ? void 0 : a.offsetTop) || 0)) / d.y,
            g = l.width / d.x,
            E = l.height / d.y;
        if (r) {
            const u = C(r),
            ...
            for (; v && n && L !== u;) {
                ...
                _.x += (v.clientLeft + parseFloat(R.paddingLeft)) * y.x, _.y += (v.clientTop + parseFloat(R.paddingTop)) * y.y, c *= y.x, m *= y.y, g *= y.x, E *= y.y, c += _.x, m += _.y, v = C(v).frameElement
            }
        }
        return yt({
            width: g,
    ...
    function Gt(e, i) {
        ...
        const n = Yt(e),
            ...
            a = C(n);
        return s ? i.concat(a, a.visualViewport || [], Tt(n) ? n : []) : i.concat(n, Gt(n))
    }

    function Qt(e, i, t) {
        let n;
        if (i === "viewport") n = function(l, r) {
            const d = C(l),
                h = Q(l),
                f = d.visualViewport;
            let c = h.clientWidth,
        ...
        else if (i === "document") n = function(l) {
            const r = Q(l),
                d = _t(l),
                h = l.ownerDocument.body,
                f = mt(r.scrollWidth, r.clientWidth, h.scrollWidth, h.clientWidth),
                c = mt(r.scrollHeight, r.clientHeight, h.scrollHeight, h.clientHeight);
            let m = -d.scrollLeft + Xt(l);
            const g = -d.scrollTop;
            return H(h).direction === "rtl" && (m += mt(r.clientWidth, h.clientWidth) - f), {
                width: f,
                height: c,
                x: m,
                y: g
            ...
            if (Rt()) {
                var s, a;
                const r = C(e);
                l.x -= ((s = r.visualViewport) == null ? void 0 : s.offsetLeft) || 0, l.y -= ((a = r.visualViewport) == null ? void 0 : a.offsetTop) || 0
            }
            n = l
        }
        return yt(n)
    ...
    function Zt(e, i) {
        return V(e) && H(e).position !== "fixed" ? i ? i(e) : e.offsetParent : null
    }
    ...
    function te(e, i) {
        ...
        return n && (Y(n) === "html" || Y(n) === "body" && H(n).position === "static" && !Ct(n)) ? t : n || function(s) {
            let a = ut(s);
            for (; V(a) && !Nt(a);) {
                if (Ct(a)) return a;
                a = ut(a)
    ...
    const Le = {
            getClippingRect: function(e) {
                ...
                const a = t === "clippingAncestors" ? function(h, f) {
                        const c = f.get(h);
                        if (c) return c;
                        let m = Gt(h).filter(L => G(L) && Y(L) !== "body"),
                            g = null;
                        ...
                        for (; G(u) && !Nt(u);) {
                            const L = H(u),
                                v = Ct(u);
                            L.position === "fixed" && (g = null), (E ? v || g : v || L.position !== "static" || !g || !["absolute", "fixed"].includes(g.position)) ? g = L : m = m.filter(y => y !== u), u = ut(u)
                        }
                        return f.set(h, m), m
                    }(i, this._c) : [].concat(t),
                    l = [...a, n],
                    ...
                    d = l.reduce((h, f) => {
                        const c = Qt(i, f, s);
                        return h.top = mt(c.top, h.top), h.right = qt(c.right, h.right), h.bottom = qt(c.bottom, h.bottom), h.left = mt(c.left, h.left), h
                    }, Qt(i, r, s));
                return {
            ...
            convertOffsetParentRelativeRectToViewportRelativeRect: function(e) {
                ...
                if ((s || !s && n !== "fixed") && ((Y(t) !== "body" || Tt(a)) && (l = _t(t)), V(t))) {
                    const h = gt(t);
                    r = ct(t), d.x = h.x + t.clientLeft, d.y = h.y + t.clientTop
                }
                return {
                    width: i.width * r.x,
                    height: i.height * r.y,
        ...
        T = class extends I {
            ...
            initListener() {
                ...
                (t = this._element) == null || t.addEventListener("click", () => {
                    ...
                    this._destroyed || this._targetElement != null && this._element != null && s.target instanceof HTMLElement && !this.clicked && !p.isElementSameOrContains(this._targetElement, s.target) && !p.isElementSameOrContains(this._element, s.target) && this.hide()
                })), window.addEventListener("click", s => {
                    if (!this._destroyed && this._targetElement != null && this._element != null && s.target instanceof HTMLElement) {
                        if (p.isElementSameOrContains(this._element, s.target)) return;
                        const a = p.isElementSameOrContains(this._targetElement, s.target);
            ...
            addComputePositionInTargetElement() {
                ...
                this._element != null && this._targetElement != null && (this._targetElement.classList.add("absolute"), ee(this._element, this._targetElement, {
            ...
            getTargetElement() {
                ...
                return typeof n == "string" ? p.findOrById(n) : n instanceof HTMLElement ? n : p.nextElementSibling(this._element)
            }
        };
    let B = T;
    o(B, "type", "dropdown"), o(B, "SELECTOR", '[data-fc-type="dropdown"]'), o(B, "EVENTS", {
    ...
    const Vt = class extends I {
        ...
        initListener() {
            for (const t of this._elements.keys()) t.addEventListener("click", () => {
                this.showTab(t)
            })
        }
        showTab(t) {
            ...
            n == null || n.classList.remove("hidden"), a.forEach(l => l.classList.add("hidden")), n == null || n.classList.add("active"), t.classList.add("active"), a.forEach(l => l.classList.remove("active")), s.forEach(l => l.classList.remove("active"))
        }
    };
    let Z = Vt;
    o(Z, "type", "tab"), o(Z, "SELECTOR", '[data-fc-type="tab"]'), o(Z, "DEFAULT", {
        attr: {
            target: "data-fc-target"
        }
    });
    const A = class extends I {
        ...
        initOptions() {
            var n;
            let t = (n = this._element) == null ? void 0 : n.getAttribute(A.DEFAULT.attr.behavior);
        ...
        show() {
            if (this.dispatchEvent(A.EVENTS.show), this._targetElement != null && this._element != null) {
                const t = document.documentElement.clientWidth;
                document.body.style.paddingRight = Math.abs(window.innerWidth - t) + "px", document.body.classList.add(A.DEFAULT.class.overflowHidden), this._element.classList.add(A.DEFAULT.class.open), this._targetElement.classList.remove(A.DEFAULT.class.hidden), setTimeout(() => {
                    this._targetElement.classList.add(A.DEFAULT.class.open), p.showOverlay(), this._windowClickListen || (window.addEventListener("click", this.onWindowClicked), this._windowClickListen = !0)
                }, 1)
            }
        ...
        hide() {
            var t;
            this.dispatchEvent(A.EVENTS.hide), this._targetElement != null && this.isShown && (document.body.classList.remove(A.DEFAULT.class.overflowHidden), (t = this._element) == null || t.classList.remove(A.DEFAULT.class.open), this._targetElement.classList.remove(A.DEFAULT.class.open), Object.assign(document.body.style, {
                paddingRight: null
            }), setTimeout(() => {
                window.removeEventListener("click", this.onWindowClicked), this._windowClickListen = !1, p.hideOverlay(), this._targetElement.classList.add(A.DEFAULT.class.hidden)
            }, 1)), window.removeEventListener("keydown", this.keyListener), this.dispatchEvent(A.EVENTS.hidden)
        }
        toggle() {
            this.isShown ? this.hide() : this.show()
        }
    ...
    o(W, "type", "modal"), o(W, "SELECTOR", '[data-fc-type="modal"]'), o(W, "EVENTS", {
        ...
        class: {
            base: "fc-modal", hidden: "hidden", open: "open", overflowHidden: "overflow-hidden"
        },
        attr: {
            target: "data-fc-target",
    ...
    const w = class extends I {
        ...
        init() {
            ...
            t ? this._targetElement = p.findOrById(t) : this._targetElement = p.nextElementSibling(this._element), this._targetElement && (this._arrowElement = this._targetElement.querySelector(`[${w.DEFAULT.attr.arrow}]`)), this.initOptions(), this.initListener()
        }
        initOptions() {
            var t, n, s, a, l;
            if ((t = this._element) != null && t.hasAttribute(w.DEFAULT.attr.placement) && (this.config.placement = (n = this._element) == null ? void 0 : n.getAttribute(w.DEFAULT.attr.placement)), (s = this._element) != null && s.hasAttribute(w.DEFAULT.attr.trigger) && (this.config.trigger = ((a = this._element) == null ? void 0 : a.getAttribute(w.DEFAULT.attr.trigger)) === "click" ? "click" : "hover"), (l = this._element) != null && l.hasAttribute(w.DEFAULT.attr.offset)) {
        ...
        computeTooltipPosition() {
            const t = [Pt(this._targetOffset), ue({
                padding: 2
            }), me({
                fallbackStrategy: "bestFit"
            })];
            this._arrowElement && t.push(ce({
                element: this._arrowElement
            })), this._element != null && this._targetElement != null && (this._targetElement.classList.add(w.DEFAULT.class.absolute), this._arrowElement && this._arrowElement.classList.add(w.DEFAULT.class.absolute), ee(this._element, this._targetElement, {
                ...
                if (Object.assign(this._targetElement.style, {
                    ...
                    const {
                        x: f,
                        y: c
                    } = a.arrow, m = f != null ? `${f}px` : `${-this._arrowElement.offsetWidth/2}px`, g = c != null ? `${c}px` : `${-this._arrowElement.offsetHeight/2}px`, E = {
    ...
    o(j, "type", "tooltip"), o(j, "SELECTOR", '[data-fc-type="tooltip"]'), o(j, "EVENTS", {
        ...
        class: {
            base: "fc-collapse", hidden: "hidden", open: "open", opacity0: "opacity-0", opacity100: "opacity-100", absolute: "absolute"
        },
        attr: {
            target: "data-fc-target",
            placement: "data-fc-placement",
    ...
    const x = class extends I {
        ...
        initOptions() {
            var a, l, r;
            let t = (a = this._element) == null ? void 0 : a.getAttribute(x.DEFAULT.attr.scroll);
            t ? this.config.scroll = t !== "false" : this.config.scroll == null && (this.config.scroll = !1);
            let n = (l = this._element) == null ? void 0 : l.getAttribute(x.DEFAULT.attr.backdrop);
            n ? this.config.backdrop = n !== "false" : this.config.backdrop == null && (this.config.backdrop = !0);
            let s = (r = this._element) == null ? void 0 : r.getAttribute(x.DEFAULT.attr.behavior);
        ...
        show() {
            if (this.dispatchEvent(x.EVENTS.show), this._targetElement != null && this._element != null && (this._targetElement.classList.remove(x.DEFAULT.class.hidden), this._element.classList.add(x.DEFAULT.class.open), this.config.backdrop && p.showOverlay(), setTimeout(() => {
        ...
        hide() {
            var t;
            this.isShown && (this.dispatchEvent(x.EVENTS.hide), this._targetElement != null && this.isShown && ((t = this._element) == null || t.classList.remove(x.DEFAULT.class.open), this._targetElement.classList.remove(x.DEFAULT.class.open), Lt.afterTransition(this._targetElement, () => {
                this._targetElement.classList.add(x.DEFAULT.class.hidden), this.config.backdrop && p.hideOverlay()
            }), this.config.scroll || (document.body.classList.remove("overflow-hidden"), Object.assign(document.body.style, {
                paddingRight: null
            }))), window.removeEventListener("keydown", this.keyListener), this.dispatchEvent(x.EVENTS.hidden))
        }
        toggle() {
            this.isShown ? this.hide() : this.show()
        }
    ...
    o(q, "type", "offcanvas"), o(q, "SELECTOR", '[data-fc-type="offcanvas"]'), o(q, "EVENTS", {
        ...
        class: {
            base: "fc-offcanvas", hidden: "hidden", open: "open"
        },
        attr: {
            target: "data-fc-target",
            dismiss: "data-fc-dismiss",
    ...
    const ht = class extends I {
        ...
        hide() {
            this.dispatchEvent(ht.EVENTS.hide), this._targetElement != null && this._targetElement.classList.add(ht.DEFAULT.class.hidden), this.dispatchEvent(ht.EVENTS.hidden)
        }
        _getTargetElement() {
            if (this._element == null) return null;
            const t = this.config.target ? ? this._element.getAttribute(ht.DEFAULT.attr.target);
    ...
    const ye = {
        ...
        St = class {
            ...
            static init() {
                this._initialize = this.retrieveFromLocal(), this._old_state = ye.deepClone(this._state)
            }
            ...
            static retrieveFromLocal() {
                ...
                return Object.keys(t).forEach(n => t[n] == null ? t[n] = this.defaultState[n] : void 0), this._state = t, !0
            }
    ...
    let D = St;
    o(D, "_old_state", null), o(D, "_initialize", !1), o(D, "stateKey", "frost.app_state"), o(D, "defaultState", {
        theme: "light"
    }), o(D, "_listener", []), o(D, "_state", St.defaultState);
    class it {
        static init() {
            D.attachListener(this.themeChangeListener), this.themeChangeListener(D.state)
        }
        static themeChangeListener(i) {
            i.theme == "system" ? (it.changeTheme(window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", it.windowThemeListener)) : (it.changeTheme(i.theme), window.matchMedia("(prefers-color-scheme: dark)").removeEventListener("change", it.windowThemeListener))
        }
    ...
    const st = class extends I {
        ...
        notifyThemeChanged(t) {
            var n, s;
            if (this.trigger != "switch")(n = this._element) == null || n.classList.remove("light-theme", "dark-theme", "system-theme"), (s = this._element) == null || s.classList.add(`${t}-theme`);
        ...
        init() {
            this._element != null && (this._element.classList.add(st.DEFAULT.class.base), this.theme = p.getAttribute(this._element, st.DEFAULT.attr.theme, this.config.theme), this.trigger = p.getAttribute(this._element, st.DEFAULT.attr.trigger, this.config.trigger), this.initListeners(), this.notifyThemeChanged(D.state.theme))
        }
        initListeners() {
            var t;
            if (this.trigger == "switch" && this._element instanceof HTMLInputElement) {
                const n = this._element;
                n == null || n.addEventListener("change", s => {
                    D.changeTheme(n.checked ? "dark" : "light"), this.setOtherSwitch()
                })
            } else this.theme != null && this.trigger != "never" && ((t = this._element) == null || t.addEventListener("click", () => {
                D.changeTheme(this.theme), this.setOtherSwitch()
            }))
        }
        setOtherSwitch() {
            const t = D.state.theme;
            p.findAll(st.SELECTOR).map(n => st.getInstanceOrCreate(n)).forEach(n => {
                n == null || n.notifyThemeChanged(t)
            })
        }
    };
    let nt = st;
    o(nt, "type", "theme_switcher"), o(nt, "SELECTOR", '[data-fc-type="theme_switcher"]'), o(nt, "DEFAULT", {
        class: {
            base: "fc-theme"
        },
        attr: {
    ...
    const kt = class {
        static get instance() {
            return this._instance == null && (this._instance = new kt), this._instance
        }
        init() {
            typeof window < "u" && (D.init(), it.init(), p.addOverlay(["transition-all", "fixed", "inset-0", "z-40", "bg-gray-900", "bg-opacity-50", "dark:bg-opacity-80"]), kt.instance.awakeComponents())
        }
        awakeComponents() {
            [O, X, B, Z, W, q, j, z, nt].map(i => p.findAll(i.SELECTOR).forEach(t => i.getInstanceOrCreate(t)))
        }
    };
    let At = kt;
    o(At, "_instance", null);
    const ie = At.instance,
        ...
        ne = ie.init;
    typeof window < "u" && (window.frost = we, ne()), b.Accordion = X, b.Collapse = O, b.Dismissable = z, b.Dropdown = B, b.Modal = W, b.Offcanvas = q, b.Tab = Z, b.ThemeSwitcher = nt, b.Tooltip = j, b.initFrost = ne, Object.defineProperty(b, Symbol.toStringTag, {
        value: "Module"
    })
});