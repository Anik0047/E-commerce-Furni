    ...
    <div class="ltr:flex flex-1 rtl:flex-row-reverse">
        <div
            ...
            <div class="xl:w-full  min-h-[calc(100vh-138px)] relative ">
                            ...
                            <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-3 xl:col-span-3">
                                <div class="w-full relative p-4">
                                    ...
                                    <div class="w-full mx-auto  mb-4">
                                        <input type="file" class="filepond" name="product_image" id="product_image"
                                ...
                                <div class="w-full relative mb-4">
                                    <div class="flex-auto p-0 md:p-4">
                                        <div class="mb-2">
                                            ...
                                            <input type="title" id="product_title" name="product_title"
                ...
                <div
                    class="absolute bottom-0 -left-4 -right-4 block print:hidden border-t p-4  dark:border-slate-700/40">
                    <div class="container">
                        <!-- Footer Start -->
                        <footer
